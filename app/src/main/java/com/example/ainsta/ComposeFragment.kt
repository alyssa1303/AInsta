    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener{
            ...
            if (photoFile != null) {
                ...
                Toast.makeText(this.context, "No photo taken", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    fun submitPost(description: String, user: ParseUser, file: File) {
        ...
        post.saveInBackground{exception ->
            if (exception != null) {
                ...
                Toast.makeText(this.context, "Error while saving post", Toast.LENGTH_SHORT).show()
            } else {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == AppCompatActivity.RESULT_OK) {
                ...
                Toast.makeText(this.context, "Picture wasn't taken!", Toast.LENGTH_SHORT).show()
            }
        }
    }
